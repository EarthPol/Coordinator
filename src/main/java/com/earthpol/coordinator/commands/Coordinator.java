        ...
        if(args.length > 0){
          if(args[0].equalsIgnoreCase("reload")){
                  ...
                  if (args[1].equalsIgnoreCase("scale")) {
                      ...
                      if(args.length > 2) {
                          ...
                          if(sender instanceof Player){
                              ...
                              Main.instance.saveConfig();
                              Main.instance.reloadConfig();
                              Main.log.info(Main.prefix + "Scale changed from §b" + prevScale + "§a to §b" + scale);
                          }
                      } else {
                          if(sender instanceof Player){
                              Player player = (Player) sender;
                              ...
                              Main.log.info(Main.prefix + "Correct Usage: §b/coordinator set scale <number>");
                              Main.log.info(Main.prefix + "Example Usage: §b/coordinator set scale 3072");
                          }
                      }
                      ...
                      if(args.length > 2) {
                          ...
                          if(sender instanceof Player){
                              ...
                              Main.instance.saveConfig();
                              Main.instance.reloadConfig();
                              Main.log.info(Main.prefix + "Tiles changed from §b" + prevTile + "§a to §b" + tiles);
                          }
                      } else {
                          if(sender instanceof Player){
                              Player player = (Player) sender;
                              ...
                              Main.log.info(Main.prefix + "Correct Usage: §b/coordinator set tiles <number>");
                              Main.log.info(Main.prefix + "Example Usage: §b/coordinator set tiles 15");
                          }
                      }
                  } else {
                      if(sender instanceof Player){
                          ...
                          Main.log.info("§e========= §bCOORDINATOR §e=========");
                          Main.log.info("§b/coordinator set §e| Sets the values in the config.yml");
                          Main.log.info("§b/coordinator set scale <number> §e| Sets scale");
                          Main.log.info("§b/coordinator set tiles <number> §e| Sets tiles");
                          Main.log.info("§e================================");
                      }
                  }
              } else {
            ...
            if(sender instanceof Player){
                Player player = (Player) sender;
                player.sendMessage("§e========= §bCOORDINATOR §e=========");
                player.sendMessage("§ePlugin by §b0xBit §e| IP: §bearthpol.com");
                ...
                Main.log.info("§e========= §bCOORDINATOR §e=========");
                Main.log.info("§b/coordinator reload §e| Reloads the configuration file.");
                Main.log.info("§b/coordinator set §e| Sets the values in the config.yml");
                Main.log.info("§e================================");
            }
        }
