...
Coordinator is a lightweight **Paper / Spigot** plugin that converts between **Minecraft X/Z coordinates** and 
**real-world latitude/longitude** for Earth-style maps.

It is designed for Earth servers (EarthPol / EarthMC-style projections) and uses a configurable scale system to map
in-game positions to real-world locations.
...
- Configuration allows messages shown to players to be heavily configured
- Supports MiniMessage and multi-line messages
...
# Licensing 
Coordinator is licensed under the Creative Commons Attribution-NonCommercial-NoDerivs 3.0 Unported (CC BY-NC-ND 3.0) 
License (http://creativecommons.org/licenses/by-nc-nd/3.0/)

We don't object to you making your own forks and builds but we do object to people being selfish, which is why we specify 
No Derivative Works. If you want to modify the code to add some nice feature the least you can do is ask and submit a pull
request to allow everyone to benefit from it.
